...
func TestCollectionHandler_DeleteCollection(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h := NewCollectionHandler(tt.svc)
			c, w := mongoCollectionContext(http.MethodDelete, "/mongodb/collections/"+tt.collection, uuid.New(), projectID, nil, params)
...
func TestCollectionHandler_AddField(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			projectID := uuid.New().String()
			h := NewCollectionHandler(tt.svc)
			c, w := mongoCollectionContext(http.MethodPost, "/mongodb/collections/users/fields", uuid.New(), projectID,
...
func TestCollectionHandler_RemoveField(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			projectID := uuid.New().String()
			h := NewCollectionHandler(tt.svc)
			c, w := mongoCollectionContext(http.MethodDelete, "/mongodb/collections/users/fields/status", uuid.New(), projectID, nil,
